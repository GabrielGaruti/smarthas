...
public final class FragmentLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialTextView txtRegisterLink;
  ...
  private FragmentLoginBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnLogin,
      ...
      @NonNull MaterialTextView txtRegisterLink) {
  ...
  public static FragmentLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.txt_register_link;
      MaterialTextView txtRegisterLink = ViewBindings.findChildViewById(rootView, id);
      if (txtRegisterLink == null) {
        break missingId;
      }

      return new FragmentLoginBinding((ScrollView) rootView, btnLogin, inputEmail, inputPassword,
          txtRegisterLink);
    }
