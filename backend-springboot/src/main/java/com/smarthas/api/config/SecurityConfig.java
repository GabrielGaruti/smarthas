...
import com.smarthas.api.security.JwtAuthFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/", "/overview", "/health", "/error", "/css/**").permitAll()
                // autenticacao
                .requestMatchers("/auth/**").permitAll()
                // documentacao Swagger e console H2
